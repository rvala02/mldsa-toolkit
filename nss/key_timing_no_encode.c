...
main(int argc, char *argv[])
{
    ...
    switch (mldsa_level) {
    case 44:
        key_len = ML_DSA_44_PRIVATEKEY_LEN;
        break;
    case 65:
        key_len = ML_DSA_65_PRIVATEKEY_LEN;
        break;
    case 87:
        key_len = ML_DSA_87_PRIVATEKEY_LEN;
        break;
    }
    ...
    fprintf(stderr, "Using ML-DSA-%d (raw keys, no_encode counter)\n", mldsa_level);
    ...
    while (1) {
        ...
        SECStatus rv = PK11_SignWithMechanism(pkey, CKM_ML_DSA, &mech_param,
                                              &sig, &data);
